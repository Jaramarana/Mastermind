...
class Board
    ...
    def drawBoard
        ...
        (0...@codes.length).each do |i|
            if i == 10
                ...
                puts "\r#{@codes[i].returnColouredCode}"
                puts "-------"
    ...
    def enterGuess
        ...
        print("Enter a guess using the numbers that corrosponde to the colour you want\n:")
